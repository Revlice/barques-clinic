                ...
                <div className="container mx-auto px-6 lg:px-16">
                    ...
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-300 text-lg max-w-3xl mx-auto">
                            Do you have questions? Contact us! You can use our contact information or fill out the form to get information.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                        ...
                        <div className="bg-[#1B2D47] p-8 w-full h-full rounded-lg shadow-xl space-y-12">
                            <h2 className="text-2xl font-semibold text-[#A5C4D4] mb-4">Contact Us</h2>

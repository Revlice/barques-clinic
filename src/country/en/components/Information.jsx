        ...
        <div className="w-full bg-logoColor/95 text-white text-sm py-2 z-10">
            <div className="container mx-auto flex flex-wrap items-center justify-between px-4 sm:px-8">
                ...
                <div className="flex items-center space-x-4 mb-2 sm:mb-0">
                    <Link to="/contact" className="hover:underline mr-4 hover:text-gray-200 transition">Make an Appointment</Link>
                    <span className="opacity-50 mr-4">|</span>
                    <Link to="https://wa.me/905060326301" className="hover:underline hover:text-gray-200 transition">Online Consultation</Link>
                </div>
